...
x1 = (x1_min, x1_min, x1_min, x1_min, x1_max, x1_max, x1_max, x1_max, value(x1_max, x1_min, -l), value(x1_max, x1_min, l),
...
x2 = (x2_min, x2_min, x2_max, x2_max, x2_min, x2_min, x2_max, x2_max, (x2_max + x2_min) / 2, (x2_max + x2_min) / 2,
      value(x2_max, x2_min, -l), value(x2_max, x2_min, l), (x2_max + x2_min) / 2, (x2_max + x2_min) / 2, (x2_max + x2_min) / 2)
x3 = (x3_min, x3_max, x3_min, x3_max, x3_min, x3_max, x3_min, x3_max, (x3_max + x3_min) / 2, (x3_max + x3_min) / 2,
      (x3_max + x3_min) / 2, (x3_max + x3_min) / 2, value(x3_max, x3_min, -l), value(x3_max, x3_min, l), (x3_max + x3_min) / 2)
...
def experiment(m):
    ...
    print('\nОтримане рівняння регресії:\ny = {0} + {1}*x1 + {2}*x2 + {3}*x3 + {4}*x1*x2 + {5}*x1*x3 + {6}*x2*x3 + '
          '{7}*x1*x2*x3 + {8}*x1^2 + {9}*x2^2 + {10}*x3^2\n'.format(round(b[0], 3), round(b[1], 3), round(b[2], 3),
                                                    round(b[3], 3), round(b[4], 3), round(b[5], 3), round(b[6], 3),
